	...
	public class LeftTabUI extends View {
		...
		protected static var uiXML:XML =
			<View width="400" height="600">
			  <Image url="png.main.tabBg" x="0" y="0" sizeGrid="25,25,25,25" width="400" height="600"/>
			  <Panel width="418" height="600" vScrollBarSkin="png.comp.vscroll" visible="true" right="-18" x="0" y="0" var="panel">
